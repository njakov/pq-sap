...
\item 
void \mbox{\hyperlink{main_8c_af2b06c0675671c7d946efdc4daf30946}{print\+\_\+hex}} (const char \texorpdfstring{$\ast$}{*}label, const uint8\+\_\+t \texorpdfstring{$\ast$}{*}data, size\+\_\+t len)
\begin{DoxyCompactList}\small\item\em Helper function to print a byte array as a hexadecimal string. \end{DoxyCompactList}\item 
...
\item ss2\mbox{[}\doxylink{params_8h_a5054c9269277412d8536eb82cfffbe15}{KYBER\+\_\+\+SSBYTES}\mbox{]}\+: Shared secret from decapsulation. The main function performs the following steps\+:
\end{DoxyItemize}
\begin{DoxyEnumerate}
...
\end{DoxyReturn}
\Hypertarget{main_8c_af2b06c0675671c7d946efdc4daf30946}\label{main_8c_af2b06c0675671c7d946efdc4daf30946} 
\index{main.c@{main.c}!print\_hex@{print\_hex}}
\index{print\_hex@{print\_hex}!main.c@{main.c}}
\doxysubsubsection{\texorpdfstring{print\_hex()}{print\_hex()}}
{\footnotesize\ttfamily void print\+\_\+hex (\begin{DoxyParamCaption}\item[{const char \texorpdfstring{$\ast$}{*}}]{label,  }\item[{const uint8\+\_\+t \texorpdfstring{$\ast$}{*}}]{data,  }\item[{size\+\_\+t}]{len }\end{DoxyParamCaption})}



Helper function to print a byte array as a hexadecimal string. 

This function takes a label and a byte array of a given length and prints the bytes in hexadecimal format. It is useful for debugging and viewing raw cryptographic data.


\begin{DoxyParams}{Parameters}
{\em label} & A label that will be printed before the byte array for identification. \\
\hline
{\em data} & The byte array to print. \\
\hline
{\em len} & The length of the byte array. \\
\hline
\end{DoxyParams}
